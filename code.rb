...
# code goes here
system ("curl http://launch-academy-chat.herokuapp.com/messages")
system ("curl --verbose -d content='woo woo it worked!' http://launch-academy-chat.herokuapp.com/messages")
